...
/// <summary>
/// This class is a base class which contains what is common to all game scenes (maps, Menus, Managers)
/// </summary>
public class GameSceneSO : DescriptionBaseSO
{
	...
	{
		//Playable scenes
		Map, //SceneSelector tool will also load PersistentManagers and Gameplay
